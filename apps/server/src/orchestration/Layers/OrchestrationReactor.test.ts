...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, auto-resume, and thread deletion reactors", async () => {
      ...
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(AutoResumeReactor, {
            start: () => {
              started.push("auto-resume-reactor");
              return Effect.void;
            },
            schedule: () => Effect.succeed(false),
            drain: Effect.void,
          }),
        ),
        Layer.provideMerge(
