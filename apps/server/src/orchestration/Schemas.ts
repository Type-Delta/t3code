import {
  ...
  ThreadCheckpointNavigationRequestedPayload as ContractsThreadCheckpointNavigationRequestedPayloadSchema,
  ThreadCheckpointNavigationCompletedPayload as ContractsThreadCheckpointNavigationCompletedPayloadSchema,
  ThreadCheckpointNavigationFailedPayload as ContractsThreadCheckpointNavigationFailedPayloadSchema,
  ThreadCheckpointForwardHistoryAbandonedPayload as ContractsThreadCheckpointForwardHistoryAbandonedPayloadSchema,
...
export const ThreadCheckpointNavigationRequestedPayload =
  ContractsThreadCheckpointNavigationRequestedPayloadSchema;
export const ThreadCheckpointNavigationCompletedPayload =
  ContractsThreadCheckpointNavigationCompletedPayloadSchema;
export const ThreadCheckpointNavigationFailedPayload =
  ContractsThreadCheckpointNavigationFailedPayloadSchema;
export const ThreadCheckpointForwardHistoryAbandonedPayload =
  ContractsThreadCheckpointForwardHistoryAbandonedPayloadSchema;
