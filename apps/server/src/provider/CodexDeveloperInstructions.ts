...
const threadToolInstructions = (browserToolsAvailable: boolean | T3CodeToolAvailability): string =>
  normalizeAvailability(browserToolsAvailable).browser ? T3_CODE_THREAD_TOOL_INSTRUCTIONS : "";
