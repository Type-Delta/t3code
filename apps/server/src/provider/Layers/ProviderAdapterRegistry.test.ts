...
const fakeCodexAdapter: CodexAdapter.CodexAdapterShape = {
  ...
  capabilities: { sessionModelSwitch: "in-session", conversationNavigation: "branching" },
  startSession: vi.fn(),
  sendTurn: vi.fn(),
  interruptTurn: vi.fn(),
...
const fakeClaudeAdapter: ClaudeAdapter.ClaudeAdapterShape = {
  ...
  capabilities: { sessionModelSwitch: "in-session", conversationNavigation: "unsupported" },
  startSession: vi.fn(),
  sendTurn: vi.fn(),
  interruptTurn: vi.fn(),
  respondToRequest: vi.fn(),
...
const fakeOpenCodeAdapter: OpenCodeAdapter.OpenCodeAdapterShape = {
  ...
  capabilities: { sessionModelSwitch: "in-session", conversationNavigation: "rollback-only" },
  startSession: vi.fn(),
  sendTurn: vi.fn(),
  interruptTurn: vi.fn(),
  respondToRequest: vi.fn(),
