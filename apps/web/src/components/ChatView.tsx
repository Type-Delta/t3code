...
function ChatViewContent(props: ChatViewProps) {
  ...
  const activeSubagentRun =
    activeRightPanelSurface?.kind === "subagent"
      ? resolveSubagentPanelRun({
          runId: activeRightPanelSurface.runId,
          surfaceTitle: activeRightPanelSurface.title,
          legacyRun: subagentRunsById.get(activeRightPanelSurface.runId),
          nativeAgent: findSubagentInPanelModel(agentPanelModel, activeRightPanelSurface.runId),
