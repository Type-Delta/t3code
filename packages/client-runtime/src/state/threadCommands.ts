...
import {
  ...
  type JumpThreadCheckpointInput,
  ...
  type UndoThreadCheckpointInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    jumpCheckpoint: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:jump-checkpoint",
      execute: (input: JumpThreadCheckpointInput) => jumpThreadCheckpoint(input),
      scheduler,
      concurrency,
    }),
    undoCheckpoint: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:undo-checkpoint",
      execute: (input: UndoThreadCheckpointInput) => undoThreadCheckpoint(input),
      scheduler,
      concurrency,
    }),
