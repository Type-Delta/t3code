...
export const SidebarThreadOrderingMode = Schema.Literals(["manual", "last_input"]);
export type SidebarThreadOrderingMode = typeof SidebarThreadOrderingMode.Type;
export const DEFAULT_SIDEBAR_THREAD_ORDERING_MODE: SidebarThreadOrderingMode = "manual";
...
export const ClientSettingsSchema = Schema.Struct({
  ...
  sidebarThreadOrderingMode: SidebarThreadOrderingMode.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_SIDEBAR_THREAD_ORDERING_MODE)),
  ),
...
export const ServerSettings = Schema.Struct({
  ...
  autoResumeOnUsageLimit: Schema.Boolean.pipe(Schema.withDecodingDefault(Effect.succeed(true))),
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  sidebarThreadOrderingMode: Schema.optionalKey(SidebarThreadOrderingMode),
