...
export const stageWindowsServerSidecar = Effect.fn("stageWindowsServerSidecar")(function* (input: {
  ...
  const sidecarDependencies = pinPatchedDependencyVersions(
    {
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  // its existing full dependency tree. Pin any dependency covered by a patch
  // because the staged workspace intentionally has no lockfile.
